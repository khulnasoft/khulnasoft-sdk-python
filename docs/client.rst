khulnasoftlib.client
----------------

.. automodule:: khulnasoftlib.client
...
.. autoclass:: Service
    :members: apps, confs, capabilities, event_types, fired_alerts, indexes, info, inputs, job, jobs, kvstore, loggers, messages, modular_input_kinds, parse, restart, restart_required, roles, search, saved_searches, settings, khulnasoft_version, storage_passwords, users
    :inherited-members:
