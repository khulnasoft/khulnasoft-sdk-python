...
from khulnasoftlib.searchcommands import Configuration, StreamingCommand
from khulnasoftlib.searchcommands.decorators import ConfigurationSetting, Option
from khulnasoftlib.searchcommands.search_command import SearchCommand
from khulnasoftlib.client import Service
from khulnasoftlib.utils import ensure_binary
...
class TestSearchCommand(TestCase):
    ...
    def test_process_scpv2(self):
        ...
        metadata = (
            ...
            '"owner": "admin",'
            '"sid": "1433261372.158",'
            '"khulnasoftd_uri": "https://127.0.0.1:8089",'
        ...
        self.assertEqual(input_header['khulnasoftVersion'], command_metadata.searchinfo.khulnasoft_version)
        ...
        self.assertEqual(command_metadata.searchinfo.khulnasoft_version, '20150522')
        self.assertEqual(command_metadata.searchinfo.khulnasoftd_uri, 'https://127.0.0.1:8089')
        ...
        self.assertEqual(command.service.authority, command_metadata.searchinfo.khulnasoftd_uri)
