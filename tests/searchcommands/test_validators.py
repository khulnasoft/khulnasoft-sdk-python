...
import tempfile
import pytest
from khulnasoftlib.searchcommands import validators
...
class TestValidators(TestCase):
    ...
    def test_file(self):
        ...
        # Create a file on $KHULNASOFT_HOME/var/run/khulnasoft
    ...
    def test_float(self):
        ...
        test(2 * maxsize)
        test('18.32123')
        self.assertRaises(ValueError, validator.__call__, 'Khulnasoft!')
