...
from khulnasoftlib.searchcommands.decorators import Configuration
...
class TestBuiltinOptions(TestCase):
    ...
    def test_logging_configuration(self):
        ...
        self.assertTrue('khulnasoftlib' in logging.Logger.manager.loggerDict)
        self.assertEqual(environment.khulnasoftlib_logger, logging.Logger.manager.loggerDict['khulnasoftlib'])
        self.assertIsInstance(environment.khulnasoftlib_logger, logging.Logger)
    ...
    def _test_boolean_option(self, option):
        ...
        # show_configuration accepts Khulnasoft boolean values
