...
import khulnasoftlib.searchcommands.internals
from khulnasoftlib.utils import ensure_binary, ensure_str
...
class Chunk:
    def __init__(self, version, meta, data):
        ...
        dialect = khulnasoftlib.searchcommands.internals.CsvDialect
