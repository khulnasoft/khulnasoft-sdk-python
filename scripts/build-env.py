...
def build_config(json_string):
    try:
        ...
        khulnasoft_config = server_config['khulnasoft']
        ...
        return {
            'host': host,
            'port': port,
            'username': khulnasoft_config['user_roles']['admin']['username'],
            'password': khulnasoft_config['user_roles']['admin']['password'],
            'version': khulnasoft_config['version'],
        }
